...
class AddressBookAbs(ABC, UserDict):
    N_LIMIT = 2
...
class AddressBook(AddressBookAbs):
    def __init__(self):
        super().__init__()
        self.count = 0
        self.call_List = list(self.data.keys())
        with open('WEB/Week 1/file_address_book.json') as reader:
            try:
    ...
    def add_record(self, record):
        ...
        with open('WEB/Week 1/file_address_book.json', 'w') as writer:
...
class Daystobirthday:
    ...
    def days_to_birthday(self):
        ...
        next_birthday = self.record.birthday_date.value.replace(
            year=today_day.year)
...
if __name__ == '__main__':
    ...
    whenbirthday1 = Daystobirthday(rec)
    print(whenbirthday1.days_to_birthday())
    ab = AddressBook()
    ab.add_record(rec)
    ...
    whenbirthday2 = Daystobirthday(rec2)
    print(whenbirthday2.days_to_birthday())
    ab.add_record(rec2)
    ...
    whenbirthday3 = Daystobirthday(rec2)
    print(whenbirthday3.days_to_birthday())
    ab.add_record(rec3)
    ...
    whenbirthday4 = Daystobirthday(rec4)
    print(whenbirthday4.days_to_birthday())
    ab.add_record(rec4)
    ...
    myfinder = RecordFinder(ab)
    print(myfinder.find_record("0634520822"))
